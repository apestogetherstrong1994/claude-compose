...
Output proposals using the [PROPOSAL] format and voice profiles using the [VOICE_PROFILE] format as raw plain text. NEVER wrap them in code fences or backticks. The frontend parses these tags directly.
